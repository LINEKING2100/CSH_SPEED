    ...
    if (mode <= 5) {
        ...
        setTimeout(function() { 
            ...
            if (mode == 2) {
                ...
                document.getElementById("title").innerHTML = '제작자'
                document.getElementById("text2").innerHTML = '<h5>LINEKING2100 ( 전소울 ) <br><br><br><br>음원 : HEAVYgiant<br><button style="color: rgb(152, 255, 207); background-color: rgba(0, 0, 0, 0.664); border: 0; font-size: 20; font-weight: bold; padding: 10 10;" onclick="openh()">여기를 눌러 유튜브 바로가기</button><br><br>도움 : spotky1004<br><button style="color: rgb(152, 255, 207); background-color: rgba(0, 0, 0, 0.664); border: 0; font-size: 20; font-weight: bold; padding: 10 10;" onclick="opens()">여기를 눌러 깃허브 바로가기</button>'
            }
        }, 400)
    }
...
function openh() {
    window.open('https://www.youtube.com/channel/UCFcFcyR8VmVg43RdGTiN3kQ')
}

function opens() {
    window.open('https://github.com/spotky1004')
}